    ...
    <div class="settings-section">
      ...
      <template v-if="!loggedIn">
        ...
        <p class="hint">
          ...
          Under "Redirect URIs" add: <code>{{ redirectUri }}</code>
        </p>
        <button class="btn-primary" :disabled="!clientId.trim()" @click="connect">
...
async function connect() {
  await login(clientId.value.trim())
}
